<div class="modal-info">
    <div class="modal-info-block">
        ...
        <div class="modal-info-block-header">
            <h3 id="server_modal_name"></h3>
            <div class="update-monitoring-btn d-flex" data-tooltip="@t('monitoring.info.refresh')" data-tooltip-conf="right">
            ...
            <div data-tooltip="@t('monitoring.info.close')" data-tooltip-conf="left" class="d-flex">
        ...
        <div class="modal-info-block-footer">
            <a class="btn size-s outline info-action" id="bt_copy_ip" data-tooltip="@t('def.copy')">@t('monitoring.copy_ip.description')</a>
            <a class="btn size-s primary info-action" id="bt_play" href="">@t('monitoring.info.play')</a>
        </div>
    </div>
</div>